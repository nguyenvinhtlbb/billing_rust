...
use crate::common::{BillingHandler, BillConfig, AuthUsersCollection};
...
pub(super) fn make_handlers(server_config: &BillConfig, tx: &Sender<u8>,db_pool: &Pool,
                            stopped_flag: &Arc<RwLock<bool>>) -> HashMap<u8, Box<dyn BillingHandler>> {
